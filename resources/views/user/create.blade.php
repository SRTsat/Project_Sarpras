...
<div class="card shadow-sm animate-fade-in">
    <div class="card-header">
        <h4 class="mb-0"><i class="bi bi-person-plus me-2"></i>Tambah User Baru</h4>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" required placeholder="Masukkan nama user">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" required placeholder="Masukkan alamat email">
                @error('email')
                    <div class="text-danger mt-2">{{ $message }}</div>
                @enderror
            </div>
            ...
            <button type="submit" class="btn btn-primary mt-3">
                <i class="bi bi-person-check-fill me-2"></i>Simpan
            </button>
        </form>
    </div>
</div>
