...
<div class="card shadow-sm animate-fade-in">
    <div class="card-header">
        <h4 class="mb-0"><i class="bi bi-box-seam me-2"></i>Tambah Barang</h4>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('barangs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_barang" id="nama_barang" class="form-control" value="{{ old('nama_barang') }}" required placeholder="Masukkan nama barang">
                @error('nama_barang')
                    <div class="text-danger mt-2">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="number" name="jumlah" id="jumlah" class="form-control" value="{{ old('jumlah') }}" required placeholder="Masukkan jumlah barang">
                @error('jumlah')
                    <div class="text-danger mt-2">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" name="kondisi" id="kondisi" class="form-control" value="{{ old('kondisi') }}" required placeholder="Masukkan kondisi barang (misal: Baik, Rusak)">
                @error('kondisi')
                    <div class="text-danger mt-2">{{ $message }}</div>
                @enderror
            </div>
